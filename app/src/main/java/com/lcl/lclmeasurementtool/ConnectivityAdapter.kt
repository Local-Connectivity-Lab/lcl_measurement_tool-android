...
//
//class ConnectivityAdapter (private val onItemClicked: (ConnectivityReportModel) -> Unit):
//    ListAdapter<ConnectivityReportModel, ConnectivityAdapter.ConnectivityReportViewHolder>(
//        DiffCallback){
//
//    companion object {
